// Package dram is the DRAM tier's memory machinery: a GC-invisible anonymous
// mmap Arena (hugepage-backed on Linux, plain pages elsewhere) carved by an
// O(1) OffsetAllocator-style bin allocator.
//
