...
# The A1 verdict: xferspike GB/s vs the iperf3 ceiling (gate: >=85%). Day 4.
set -euo pipefail
...
for host in "$A_PUB" "$B_PUB"; do scp -o StrictHostKeyChecking=accept-new /tmp/xferspike-linux "ec2-user@$host:/tmp/xferspike"; done
